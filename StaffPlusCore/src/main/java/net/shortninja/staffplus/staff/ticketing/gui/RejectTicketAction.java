...
public class RejectTicketAction implements IAction {
    ...
    public void click(Player player, ItemStack item, int slot) {
        ...
        if (options.ticketingConfiguration.isClosingReasonEnabled()) {
            ...
            messageCoordinator.send(player, "&6        You have chosen to reject this ticket", messages.prefixTickets);
            messageCoordinator.send(player, "&6Type your closing reason in chat to reject the ticket", messages.prefixTickets);
            ...
            playerSession.setChatAction((player1, message) -> {
                ...
                manageTicketService.closeTicket(player, new CloseTicketRequest(ticketId, TicketStatus.REJECTED, message));
            });
        } else {
            manageTicketService.closeTicket(player, new CloseTicketRequest(ticketId, TicketStatus.REJECTED, null));
        }
    }
