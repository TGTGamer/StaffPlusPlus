...
import net.shortninja.staffplus.staff.ticketing.cmd.CreateTicketCmd;
import net.shortninja.staffplus.staff.ticketing.cmd.ManageTicketsGuiCmd;
import net.shortninja.staffplus.staff.ticketing.cmd.MyTicketsCmd;
...
public class CmdHandler {
    ...
    private BaseCmd[] loadCommands() {
        return new BaseCmd[]{
            ...
            new BaseCmd(new ManageTicketsGuiCmd(options.manageTicketsConfiguration.getCommandManageTicketsGui()), options.ticketingConfiguration.isEnabled(), options.manageTicketsConfiguration.getPermissionView(), "Open the manage Tickets GUI.", ""),
            new BaseCmd(new MyTicketsCmd(options.ticketingConfiguration.getMyTicketsCmd()), options.ticketingConfiguration.isEnabled(), options.ticketingConfiguration.getMyTicketsPermission(), "Open my tickets gui", ""),
            new BaseCmd(new CreateTicketCmd(options.ticketingConfiguration.getCreateTicketCmd()), options.ticketingConfiguration.isEnabled(), "Create a ticket.", "[description]"),
